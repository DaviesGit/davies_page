...
这个是以前给自己写的一个网站，动画效果还不错，可惜后面事情比较多，就做了一个首页。
演示地址：[https://daviesgit.github.io/davies_page](https://daviesgit.github.io/davies_page)

![result00](readme_images/result00.gif)
...
2. 复制 `该项目` 到`/var/www/html/`文件夹，并添加可执行权限。
